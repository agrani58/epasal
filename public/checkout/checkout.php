      ...
      <div class="col-7 product-wrapper">
        <div class="row row-horizontal card-container-summary">
          <div class="col card-product-summary row">
            <img class="col" src="/public/img/products/Dahi Lassi.jpg" alt="photo of lassi" />
          ...
          <div class="col card-product-summary row">
            <img class="col" src="/public/img/products/C Momo.jpeg" alt="photo of momo" />
          ...
          <div class="col card-product-summary row">
            <img class="col" src="/public/img/products/cheese pizza.jpg" alt="photo of pasta" />
