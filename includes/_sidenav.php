...
<div class="sidebar__container"> <img class="sidebar__logo" src="/epasale/public/img/epasal-primary-logo.png"
    ...
    <ul class="sidebar__nav">
        ...
        if (hasRole($_SESSION["roles"], ["Admin"])) {
            echo '<li class="sidebar__nav-link"><a href="/epasale/dashboard/index.php">Dashboard</a></li>
            <li class="sidebar__nav-link"><a href="/epasale/dashboard/category/AddCategory.php">Categories <i
        ...
        <?php
        if (hasRole($_SESSION["roles"], ["Admin"])) {
            echo '<li class="sidebar__nav-link"><a href="/epasale/dashboard/user/ListSeller.php">Users<i
            class="fa fa-angle-down"></i></a>
                <ul class="sidebar__nav-dropdown">
        ...
        if (hasRole($_SESSION["roles"], ["Seller"])) {
            echo '<li class="sidebar__nav-link"><a href="#">Products<i class="fa fa-angle-down"></i></a>
                <ul class="sidebar__nav-dropdown">
        ...
        ?>
        <?php
        if (hasRole($_SESSION["roles"], ["Admin", "Driver"])) {
