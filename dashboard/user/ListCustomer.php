                ...
                <tbody>
                    ...
                    foreach ($customerList as $row) {
                        ...
                        echo "<td align='center'>
                                 <form method='POST'>
                                    <a class='button btn-primary' href='/epasale/dashboard/category/AddCategory.php?id={$customer_id}'>Block</a>
                                    <input type='text' name='category_id' value='{$customer_id}'  hidden />
                                 </form>
                              </td>";
                        echo "</tr>";
