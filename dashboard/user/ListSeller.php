                ...
                <tbody>
                    ...
                    foreach ($sellerList as $row) {
                        ...
                        echo "<td align='center'>
                                 <form method='POST'>
                                    <a class='button btn-primary' href='/epasale/dashboard/category/AddCategory.php?id={$seller_id}'>Block</a>
                                    <input type='text' name='category_id' value='{$seller_id}'  hidden />
                                 </form>
                              </td>";
                        echo "</tr>";
