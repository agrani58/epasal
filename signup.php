...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $userManager->addUser($_POST, $_FILES);
}
?>
...
<body>
    ...
    <div class="form__container">
        <div class="form shadow">
            ...
            <form class="form__wrapper" onsubmit="return SignUpValidateForm()" id="registerForm" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="form-label" for="user_photo_url">Your Photo *</label>
                    <input class="form-input" type="file"  name="user_photo_url"
                        id="user_photo_url">
