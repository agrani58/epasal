...
<html lang="en">
  ...
  <body>
    <div class="sidebar__container">
      <img class="sidebar__logo" src="/epasale/public/img/epasal-primary-logo.png" alt="logo" />
      ...
      <ul class="sidebar__nav">
        ...
        <li class="sidebar__nav-link">
          <a href="#">Manage Users <i class="fa fa-angle-down"></i></a>
          <ul class="sidebar__nav-dropdown">
        ...
        <li class="sidebar__nav-link">
          <a href="#">Manage Shops <i class="fa fa-angle-down"></i></a>
          <ul class="sidebar__nav-dropdown">
